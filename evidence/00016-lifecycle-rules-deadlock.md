...
- 期限は実在する。frozen 5 件（ADR-00001/002/003/005、EVID-00004）と REV-00001 は `last_reviewed: 2026-08-08` であり、2026-11-07 に 91 日となって失敗する。REV-00002..004（2026-08-09 付）は 2026-11-08 に続く。規約準拠の修復手段は存在しない
...
- 解消方式（レビュー証跡の分離、effective freshness の導出、後継優先など）はここでは主張しない。設計判断は ADR を要する（OQ-00013）

## 関連

- [ADR-00003](../adr/00003-frozen-immutability.md) — frozen 不変性の決定
- [ADR-00004](../adr/00004-staleness-policy.md) — 90 日鮮度ポリシーの決定
- [ADR-00005](../adr/00005-reviews-append-only.md) — reviews 追記のみの決定
- [ADR-00012](../adr/00012-review-attestations.md) — 本観測を受けた解消（レビュー証跡の分離・実効レビュー日・未来日拒否・週次実行・macOS 対応）
- [PB-00003](../playbook/00003-run-review-cycle.md) / [PB-00005](../playbook/00005-fix-staleness-ci.md) — 影響を受ける手順
- [REV-00005](../reviews/00005-adversarial-review.md) — 本観測の出所となった敵対レビュー
- OQ-00013 / OQ-00014（ledger/open-questions.md）
