...
| ADR-006 | 37 | 17 | 文脈を Tier 0〜3 に分け、ロード順を固定する |
...
| ADR-020 | 27 | 32 | 認証は git の外の IdP、git は認証情報を使わず、PF は汎用クライアントとする |
...
| EVID-009 | 25 | 7 | 文脈は有限予算であり、常時ロードは劣化を招く |
