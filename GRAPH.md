...
| ADR-00014 | 43 | 21 | 実装スペックを契約・決定・振る舞いに分け、不可逆な箇所にだけ設計を残す |
...
| ADR-00010 | 36 | 19 | 知識グラフを構造層と意味層に分け、構造層だけを CI に置く |
...
| 追随していない決定 | ADR-00013 → ADR-00010 | 根拠が更新されたのに決定が再確認されていない |
| 追随していない決定 | ADR-00015 → ADR-00014 | 根拠が更新されたのに決定が再確認されていない |
| 追随していない決定 | ADR-00017 → ADR-00010 | 根拠が更新されたのに決定が再確認されていない |
| 追随していない決定 | ADR-00017 → ADR-00014 | 根拠が更新されたのに決定が再確認されていない |
| 追随していない決定 | ADR-00019 → ADR-00014 | 根拠が更新されたのに決定が再確認されていない |
