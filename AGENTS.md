...
外部の spec（requirements / design / tasks）との受け渡しは [ADR-00008](adr/00008-sdd-bridge.md) と [PB-00008](playbook/00008-bridge-sdd-spec.md) に従う。spec 本文は取り込まず、リンクと ID だけを持つ。PdO の要件（ビジネススペック）を受け入れ例まで詰める手順は [PB-00020](playbook/00020-refine-acceptance-from-design.md)。
