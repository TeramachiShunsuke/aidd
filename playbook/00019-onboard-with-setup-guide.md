...
1. 対象の層を 1 つ選ぶ。共感の有無は問わない（[ADR-00021](../adr/00021-two-layer-setup-guide.md)）
   - **最低限**: ワークフローを無駄なく使いたい
...
5. 案件リポの clone 手順や製品画面が尋ねられたら、kernel の SETUP には書かないと伝え、[PB-00017](00017-apply-kernel-to-project.md) へ渡す。繰り返す判断だけが kernel に残る（[ADR-00008](../adr/00008-sdd-bridge.md) / [ADR-00019](../adr/00019-kernel-and-project-layers.md)）
