...
2. 各項目に「他プロジェクトでも同じ判断を繰り返すか？」を問い、**繰り返さないものは KB（kernel）に持ち込まない**。案件限りの決定は案件リポ側に置く（[ADR-00019](../adr/00019-kernel-and-project-layers.md)、[PB-00017](00017-apply-kernel-to-project.md)）
3. 繰り返すものを種別に振り分ける
   - 観測・計測結果 → [PB-00001](00001-add-evidence.md) で `evidence/`
   - 横断で再利用する決定 → [PB-00002](00002-write-adr.md) で `adr/`
...
6. [PB-00007](00007-rebuild-index.md) で `INDEX.md` を再生成する
...
- [EVID-00011](../evidence/00011-spec-first-reduces-rework.md)
