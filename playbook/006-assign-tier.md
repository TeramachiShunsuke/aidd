...
1. [ADR-006](../adr/006-context-tiers.md) の表で、その文書の既定 Tier を確認する
...
7. `bash .github/scripts/build-index.sh` で [INDEX.md](../INDEX.md) を再生成する（[PB-007](007-rebuild-index.md)）
...
Tier を上げたい文書が複数ある、または Tier 0/1 を恒常的に増やしたくなった場合は、個別対応せず [ledger/open-questions.md](../ledger/open-questions.md) に論点を出し、[ADR-006](../adr/006-context-tiers.md) の後継 ADR で階層自体を見直す。
