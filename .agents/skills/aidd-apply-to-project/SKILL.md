...
1. [ADR-00019](../../../adr/00019-kernel-and-project-layers.md) — 二層の権威
2. [PB-00017](../../../playbook/00017-apply-kernel-to-project.md) — 手順の正本
3. [ADR-00008](../../../adr/00008-sdd-bridge.md) — 昇格の境界
...
4. 繰り返す判断だけ PB-00008 で kernel へ戻す
5. 散在ソースから根拠を起こすときは PB-00018 へ

## 禁止事項

- kernel の ADR / evidence を案件の同じ一覧にコピーして混ぜる
- 案件限りの決定を kernel の `adr/` に書く
- 手順の詳細をこのファイルに書き写す（正本は PB-00017）
