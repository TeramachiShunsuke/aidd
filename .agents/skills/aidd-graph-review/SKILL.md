...
1. [ADR-010](../../../adr/010-knowledge-graph-layers.md) — 構造層と意味層の分離、CI が落とす 4 条件
2. [PB-010](../../../playbook/010-review-with-graph.md) — 手順の正本
3. 定期レビュー全体は [PB-003](../../../playbook/003-run-review-cycle.md)
