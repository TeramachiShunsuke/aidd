...
| ADR-013 | 実装スペックを契約・決定・振る舞いに分け、不可逆な箇所にだけ設計を残す | [adr/013-implementation-spec-split.md](adr/013-implementation-spec-split.md) | active | 2026-08-09 |
| ADR-014 | DB / インフラの文脈を制約・契約・状態に分け、状態は文書化しない | [adr/014-infra-context-layers.md](adr/014-infra-context-layers.md) | active | 2026-08-09 |
...
| EVID-017 | 振る舞いを文書とテストに二重で持つと、文書だけが腐る | [evidence/017-tests-outlive-design-docs.md](evidence/017-tests-outlive-design-docs.md) | active | 2026-08-09 |
| EVID-018 | 変更コストは対称でなく、不可逆な決定だけが事前設計に見合う | [evidence/018-change-cost-is-asymmetric.md](evidence/018-change-cost-is-asymmetric.md) | active | 2026-08-09 |
| EVID-019 | インフラ文書は状態を含むと、鮮度検査が追いつかない速さで腐る | [evidence/019-infra-state-rots-fastest.md](evidence/019-infra-state-rots-fastest.md) | active | 2026-08-09 |
